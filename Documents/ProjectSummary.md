...
### Bivariate EDA
![bivariate EDA example](../Documents/Screenshots/bivariate_example.png)

* **Trend Line Segments**: shows the trend of outcome rate across different variable values
* **Histogram**: strength of association between each variable and outcome
